...
#이미지 불러오기
# path = 'm.png'
# img_ori = cv2.imread(path,cv2.IMREAD_COLOR)
img_ori = cv2.imread('aaaa.jpg')
#너비,높이,채널의 값을 저장
height, width, channel = img_ori.shape

#matplotlib을 이용하여 저장된 너비, 높이, 채널 출력
...
#plt.xlabel("blur and Threshold", fontsize=15)
...
for i, plate_img in enumerate(plate_imgs):
    ...
    pytesseract.get_languages(config='--psm7 --oem 0')
    chars = pytesseract.image_to_string(img_result, lang='kor_vert')
